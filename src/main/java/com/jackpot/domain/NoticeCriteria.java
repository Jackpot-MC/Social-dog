...
public class NoticeCriteria {
	...
	public NoticeCriteria(int pageNum) {
		this(pageNum, 10);
	}
	...
	public String getLinkWithNoticeId(String base, Long noticeId) { //Criteria에 없는 정보를 더 추가
		return getLink(base, pageNum) + "&noticeId=" + noticeId;
	}
