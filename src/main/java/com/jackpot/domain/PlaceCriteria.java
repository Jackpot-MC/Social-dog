...
public class PlaceCriteria {
	...
	public PlaceCriteria(int pageNum) {
		this(pageNum, 10);
	}
	
	public PlaceCriteria(int pageNum, int amount) {
	...
	public String getLinkWithAppointmentId(String base, Long placeId) { //Criteria에 없는 정보를 더 추가
		return getLink(base, pageNum) + "&placeId=" + placeId;
	}
