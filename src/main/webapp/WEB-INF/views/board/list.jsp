...
<section class="board-list">
	<div class="page-title">
		...
		<div class="card-container" style="max-width: 900px; margin: auto;">
			<form enctype="multipart/form-data">
				<div class="row">
					<c:forEach var="board" items="${list}">
						<div class="col-sm-6 col-md-4 mb-3">
							<div class="card">
								<a href="${cri.getLinkWithBno('get', board.bno)}"> <img
									class="card-img-top" src="/board/boardPhoto/lg/${board.bno}"
