...
<link
  rel="stylesheet"
  href="/resources/css/appointment/list.css"
  type="text/css"
/>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 themed-grid-col">
      <div class="map_wrap">
        ...
        <!-- 카테고리 -->
        <ul id="category">
          <li id="치킨" data-order="0">
            <span class="category_bg bank"></span>치킨
          </li>
          <li id="공원" data-order="1">
            <span class="category_bg mart"></span>공원
          </li>
          <li id="동물병원" data-order="2">
            <span class="category_bg pharmacy"></span>동물병원
          </li>
        </ul>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <iframe
                id="embeddedTerm"
                src="https://place.map.kakao.com/8128910"
